...
This document is the execution plan for migrating from `crates/nooboard-desktop` to
`crates/nooboard-gui`.
...
Build a new `crates/nooboard-gui` crate that:

- preserves the visual language of `crates/nooboard-desktop`
- preserves the existing responsive layout behavior of `crates/nooboard-desktop`
...
It is a clean GUI rewrite that uses the current desktop UI as a visual reference implementation.
...
The old desktop crate is split into two categories:

### 3.1 Non-portable source

The following old desktop source is non-portable and MUST be rewritten:

- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/state/live_app.rs`
- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/state/live_commands.rs`
- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/state/mod.rs`
...
The following old desktop source is visually portable and MAY be used as reference or as a visual
copy base:

- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/ui/bootstrap/*`
- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/ui/workspace/*`
- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/src/ui/theme.rs`
- `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/build.rs`
- packaging metadata from
  `/Users/zero/study/rust/nooboard/crates/nooboard-desktop/Cargo.toml`
