...
pub(crate) type NetworkStream = TlsStream<TcpStream>;
pub(crate) type NetworkFramed = Framed<NetworkStream, LengthDelimitedCodec>;
...
impl TlsContext {
    pub(crate) fn ephemeral() -> Result<Self, TransportError> {
    ...
    pub(crate) async fn accept(&self, stream: TcpStream) -> Result<NetworkStream, TransportError> {
    ...
    pub(crate) async fn connect(
        ...
        stream: TcpStream,
        server_name: &str,
    ) -> Result<NetworkStream, TransportError> {
