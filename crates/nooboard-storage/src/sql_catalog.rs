...
pub struct SqlCatalog {
    ...
    pub list_history_head: String,
    pub list_history_older_from_anchor: String,
    pub list_history_newer_from_anchor: String,
...
impl SqlCatalog {
    pub fn load() -> Self {
        Self {
            ...
            list_history_head: include_str!("../sql/queries/list_history_head.sql").to_string(),
            list_history_older_from_anchor: include_str!(
                "../sql/queries/list_history_older_from_anchor.sql"
            )
            .to_string(),
            list_history_newer_from_anchor: include_str!(
                "../sql/queries/list_history_newer_from_anchor.sql"
            )
            .to_string(),
